...
from .select import Select, SelectOption, ChannelSelect, RoleSelect
...
class Label[T](discord.ui.Label):
    ...
    def default(self, value: str | SelectOption | None) -> None:
        if isinstance(self.component, TextInput):
            if not isinstance(value, str) and value is not None:
                raise TypeError("value must be a str or None for TextInput components")
    ...
    def placeholder(self, value: str | LocaleStr | None) -> None:
        if isinstance(self.component, (TextInput, Select)):
            ...
            raise TypeError("placeholder can only be set for TextInput or Select components")
    ...
    def max_value(self, value: int | None) -> None:
        if isinstance(self.component, TextInput):
            ...
            raise TypeError("max_value can only be set for TextInput components")
    ...
    def min_value(self, value: int | None) -> None:
        if isinstance(self.component, TextInput):
            ...
            raise TypeError("min_value can only be set for TextInput components")
    ...
    def value(self) -> str:
        ...
        raise TypeError("value can only be retrieved for TextInput or Select components")